...
perch.data <- (read.table(paste(folder,"/Data/Perch2.dat",sep=""),header=TRUE))
perch.meshsizes <- c(14,17,21.5,25,30,33,38,45)
...
plots(fit=perch.fit,meshsizes=perch.meshsizes,cdata=perch.data,BS=FALSE,plot.lens=seq(0.0001,50,0.01),label=TRUE,save=TRUE,save.to=output.folder,name="perch2")
